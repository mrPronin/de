...
- Reference table of verbs with fixed prepositions (Rektion): `verben/rektion/verben-mit-prapositionen.yaml` (36 Akk + 27 Dat, UA/EN) → generated `verben/verben-mit-prapositionen.md` via `scripts/rektion_to_md.py`.
